...
class CreateConfigsSchema(Schema):
    exchange_1 = fields.String(required=True, validate=lambda x: x in Exchanges.to_list())
    exchange_2 = fields.String(required=True, validate=lambda x: x in Exchanges.to_list())
    coin = fields.String(required=True, validate=lambda x: x in Coins.to_list())
